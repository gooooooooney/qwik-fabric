...
import type { Coordinate} from './translate';
...
function calculateLeft(style: any, curPositon: Coordinate, proportion: number, needLockProportion, pointInfo) {
    const { symmetricPoint, curPoint } = pointInfo
    const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
export default function calculateComponentPositonAndSize(name: any, style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
